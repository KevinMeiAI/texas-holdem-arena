...
function NewTournament({ csrfToken }: { csrfToken: string }) {
  ...
  return (
    <>
      <div className="admin-heading"><div><h1>创建锦标赛</h1><p>选择 2—9 个模型，共用同一份策略提示词</p></div><Link className="text-button" to="/admin">放弃并返回</Link></div>
